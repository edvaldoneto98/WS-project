package com.example.WS_project.config;

import java.time.Instant;
import java.util.Arrays;

import com.example.WS_project.entities.*;
import com.example.WS_project.repositories.*;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.boot.CommandLineRunner;
import org.springframework.context.annotation.Configuration;
import org.springframework.context.annotation.Profile;

import com.example.WS_project.entities.enums.OrderStatus;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User u2= new User(null, "John Doe", "john@gmail.com", "977777777", "654321");
